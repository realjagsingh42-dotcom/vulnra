...
--
-- Structure:
--   PASS 1 — All tables + indexes + triggers   (no cross-table references)
--   PASS 2 — Enable RLS on every table
--   PASS 3 — All RLS policies                  (all tables guaranteed to exist)
-- ─────────────────────────────────────────────────────────────────────────────

-- ═══════════════════════════════════════════════════════════════════════════
-- PASS 1 — TABLES AND INDEXES
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ── 5. SENTINEL WATCHES ──────────────────────────────────────────────────────
-- Column names match supabase_service.py:
--   url, interval_hours, tier, last_scan, last_risk_score, notification_email, active
...
-- ═══════════════════════════════════════════════════════════════════════════
-- PASS 3 — RLS POLICIES
-- All tables exist at this point. Each policy is guarded by IF NOT EXISTS.
-- ═══════════════════════════════════════════════════════════════════════════
...
BEGIN
  ...
  -- organizations: org_select_member references organization_members (exists now)
  ...
  -- audit_logs: references organization_members (exists now)
